...
import Class17 from "../L17-Panel/class17"
            ...
            {Popup.clearQueue()}
            {
                Popup.create({
                    ...
                    content: <p>Help the dog find his bone but you dont know the location of the bone. Bone class can be seen this time so you are able to see how the getter methods work, like last time call on two getter methods that are made for you "getRow()" and "getCol()" to access the row and col.
                        Click the Bone Class button to view the class. Use the for loop again the variable steps will be a counter that will be passed into the for loop to determine
        ...
        <div className="container" >
            <div className="boardcontainer16">
                ...
                <div class="in">
                    ...
                    <button type="submit" class="buttonBone" onClick={Class17}>Bone Class</button>
                </div>
