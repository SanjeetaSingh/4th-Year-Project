        ...
        <div class="containPop">
            ...
            {Popup.create({
                ...
                content: <p>
                    ...
                    <br />
                    <br />
                    <b>i.e </b> In this level we are storing the row and column value of the bowl and then calling on those variables in the if statement. The 
...
export default varInformationstepsrc;
